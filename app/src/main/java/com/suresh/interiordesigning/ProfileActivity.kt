...
class ProfileActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val takePhotoLauncher = registerForActivityResult(ActivityResultContracts.TakePicture()) { isSaved ->
            ...
            InteriorDesigningTheme() {
                Box(modifier = Modifier.fillMaxSize()) {
                    Column(
                        ...
                        HeadingTextComponent(value = "Name :Suresh")

                        HeadingTextComponent(value = "Email : suresh@gmail.com")
